			...
			<ul class="navbar_menu">
				<div class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
						...
						<li><a class="dropdown-item" name="genre" href="genreaction.jsp?genre=뮤지컬">뮤지컬</a></li>
						<li><a class="dropdown-item" name="genre" href="genreaction.jsp?genre=드라마">드라마</a></li>
					</ul>
				</div>
