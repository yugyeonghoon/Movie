...
<%
	...
	List<BoardVO> list = dao.listView(searchType, keyword, startNum, limitPerPage, 2);
	
	int totalCount = dao.getCount(searchType, keyword, 2);
        ...
        <ul class="post-list">
        	...
        	%>
				<li class="post-item" style="background:<%= boardType == 0 ? "lightgray" : "white" %>;">
					<a href="post.jsp?no=<%= no %><%= searchType != "" ? "&searchType="+searchType : ""%><%= keyword != "" ? "&searchKeyword="+keyword : "" %>"><%=title %></a>
